  ...
  private async upPostgres(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE "namespace" (
        ...
        "access_policy" varchar(16) NOT NULL DEFAULT 'PRIVATE',
        ...
        CONSTRAINT "CHK_namespace_access_policy" CHECK ("access_policy" IN ('PRIVATE', 'PUBLIC')),
        CONSTRAINT "CHK_namespace_public_not_encrypted" CHECK (NOT ("access_policy" = 'PUBLIC' AND "encryption_policy" = 'ENCRYPTED')),

...
@Module({
  imports: [
    ...
    TypeOrmModule.forFeature([NamespaceEntity, VfsNodeEntity, BlobEntity, IdempotencyKeyEntity]),
  ],
  providers: [NamespaceProvisioningRepository, VfsNodeRepository, BlobRepository],
  exports: [TypeOrmModule, NamespaceProvisioningRepository, VfsNodeRepository, BlobRepository],
})
